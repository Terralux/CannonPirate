    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                fixed2 mTiling = Tiling;
                fixed2 WavePanningV = (mTiling+mWaveSpeed*float2(0,1));
                fixed4 node_4911 = tex2D(_Normals,WavePanningV);
                fixed2 WavePanningU = (mTiling+mWaveSpeed*float2(0.9,0));
                fixed4 node_49111 = tex2D(_Normals,WavePanningU);
                fixed3 Normals = (node_4911.rgb*node_49111.rgb);
...
///////// Gloss:
                float gloss = 1.0 - (saturate(( node_49111.g > 0.5 ? (1.0-(1.0-2.0*(node_49111.g-0.5))*(1.0-node_4911.r)) : (2.0*node_49111.g*node_4911.r) ))*_Glossiness); // Convert roughness to gloss
